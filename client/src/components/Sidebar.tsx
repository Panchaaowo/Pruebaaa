...
// Agregamos 'Users' a los imports de lucide-react
import { Package, ShoppingCart, ClipboardList, Wrench, Menu, LogOut, User, LayoutDashboard, Users } from "lucide-react";
...
// Agregamos la ruta de clientes aquí
const links = [
  { href: "/dashboard", label: "Dashboard", icon: LayoutDashboard },
  { href: "/inventory", label: "Inventario", icon: Package },
  { href: "/purchases", label: "Compras", icon: ShoppingCart },
  { href: "/work-orders", label: "Órdenes de Trabajo", icon: ClipboardList },
  { href: "/clients", label: "Clientes", icon: Users }, // <--- NUEVA SECCIÓN
];

export function Sidebar() {
  // ... (El resto del componente Sidebar se mantiene exactamente igual)
